...
def make_config(
    ...
    if model_name == "per_token" and per_token_memory_dim is not None:
        cfg.memory_dim = per_token_memory_dim
        ...
        if recurrent_shape is not None:
            ...
            cfg.num_memory_tokens = matched_recurrent_tokens_for_per_token(cfg, sequence_length=seq_len)
        cfg.recurrent_memory_dim = cfg.hidden_size
    elif model_name == "kvm":
        if recurrent_shape is not None:
            cfg.num_memory_tokens = recurrent_shape[0]
            ...
            cfg.num_memory_tokens = matched_kvm_tokens_for_per_token(cfg, sequence_length=seq_len)
    return cfg
