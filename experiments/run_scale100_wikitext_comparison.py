"""Run the optional ~100M WikiText-103 scale-point comparison.

This mirrors the 35M WikiText comparison but uses a larger backbone. The
...
CONFIGS = [
    "scale100_wikitext_baseline.yaml",
    "scale100_wikitext_per_token.yaml",
    "scale100_wikitext_recurrent.yaml",
]
