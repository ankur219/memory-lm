"""Print compact markdown tables for 35M-scale RMT real-LM probe logs."""
...
LOGS = {
    "TinyStories RMT-style": "large_tinystories_rmt",
    "WikiText-103 RMT-style": "large_wikitext_rmt",
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--suffix",
        default=None,
        help="Prefer logs with this suffix, e.g. steps10000_bs8.",
    )
