"""Print a compact markdown table for the large TinyStories comparison logs."""
...
def main():
    ...
    if not rows:
        print("No large TinyStories log files found in logs/. Run experiments/run_large_tinystories_comparison.py first.")
        return
